function create_final_video(track_props, tracks, spot_record, param, file_name, directory)
...
%     imshow(I_int, [params.prominence_low*params.prominence_high
%        params.prominence_high*3]);
    imshow(I_int,mean(I_int(:))+[-prom_low, prom_high]);
